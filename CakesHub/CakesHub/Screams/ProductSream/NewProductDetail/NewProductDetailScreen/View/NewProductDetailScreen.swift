...
struct NewProductDetailScreen: View {

    // MARK: View Model

    typealias ViewModel = NewProductDetailViewModel
    ...
    @State private var isPressedLike: Bool
...
private extension NewProductDetailScreen {
...
#Preview {
    NewProductDetailScreen(viewModel: .mockData)
}
